...
Splitting videos in Canva allows you to create multiple segments from a single video, making it easier to focus on specific parts or create different versions of your content. This feature is especially useful for social media clips or presentations where you want to highlight key moments.
...
The split tool is available on most mobile devices, but there might be some limitations on certain platforms like the iPad, where the functionality is not fully supported.
...
While Canva is great for basic editing, for more advanced features, you might want to consider using a dedicated video editing app like CapCut.